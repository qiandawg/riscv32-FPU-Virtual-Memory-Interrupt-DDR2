...
#
# Script generated by Vivado on Tue Apr 21 19:16:38 -0500 2026
...
#
# Usage        : mig.sh
#                mig.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mig.sh [-reset_run]
#                mig.sh [-reset_log]
#                mig.sh [-help]
#
...
# script info
echo -e "mig.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mig.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mig xil_defaultlib.mig xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mig -key {Behavioral:sim_1:Functional:mig} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mig.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mig.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mig.sh [-help]\n\
Usage: mig.sh [-step]\n\
Usage: mig.sh [-lib_map_path]\n\
Usage: mig.sh [-reset_run]\n\
Usage: mig.sh [-reset_log]\n\
Usage: mig.sh [-keep_index]\n\
Usage: mig.sh [-noclean_files]\n\n\
