...
#                script (type 'mig.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/JHU_Classes/Spring2026_DDR2/DDR2_Cursor/RISCVpipelinedRV32IMF_INT_VM_Cache.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
