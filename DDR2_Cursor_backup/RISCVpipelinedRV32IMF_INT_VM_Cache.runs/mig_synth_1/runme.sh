...
HD_PWD='C:/JHU_Classes/Spring2026_DDR2/DDR2_Cursor/RISCVpipelinedRV32IMF_INT_VM_Cache.runs/mig_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mig.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mig.tcl
